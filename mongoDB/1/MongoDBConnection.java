...
public class MongoDBConnection {
    ...
    private static final String USERNAME = "zerdaxsjc_db_user";
    private static final String PASSWORD = "EMDBzhWONslnvT0i";
//    private static final String CLUSTER_URL = "cluster0.brbyr.mongodb.net"; // Substitua pelo seu cluster se for diferente
    private static final String CLUSTER_URL = "cluster0.xjh7o82.mongodb.net"; // Substitua pelo seu cluster se for diferente
